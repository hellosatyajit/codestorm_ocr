"""
Django settings for codestorm_ocr project.
...
SECRET_KEY = 'django-insecure-15p0245ilgkyrujts39)xg7g(*4eyz99mix-o!4j0g5)=k&8^('
...
ROOT_URLCONF = 'codestorm_ocr.urls'
...
WSGI_APPLICATION = 'codestorm_ocr.wsgi.application'
